...
async function getSmallDetails(vehicleName) {
  ...
  try {
    ...
    // converting speed that is wrtitten in format such as 5,000 to 5000
    const temp_max_speed = max_speed_alt.split("(")[1];
    ...
    const specs = {
      turn_stock: turn_rate_stock,
      turn_upgrade: turn_rate_upgraded,
      speed_stock: max_speed_stock,
      speed_upgraded: max_speed_upgraded,
      speed_alt: formatted_alt,
    };
